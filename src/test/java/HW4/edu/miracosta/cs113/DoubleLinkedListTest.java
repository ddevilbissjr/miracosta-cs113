...
public class DoubleLinkedListTest {
    ...
    public void testGet() {
        ...
        assertEquals("Expected value in Integer list doesn't match get() from your list", Integer.valueOf(INT_VALUES[3]), intList.get(3));
        assertEquals("Expected value in Character list doesn't match get() from your list", Character.valueOf(CHAR_VALUES[3]), charList.get(3));
        assertEquals("Expected value in Double list doesn't match get() from your list", Double.valueOf(DOUBLE_VALUES[3]), doubleList.get(3));
    }
    ...
    public void testRemoveByIndex() {
        ...
        assertEquals("Remove from Integer list was not successful, removed wrong value", Integer.valueOf(INT_VALUES[1]), intList.remove(1));
        assertEquals("Remove from Character list was not successful, removed wrong value", Character.valueOf(CHAR_VALUES[2]), charList.remove(2));
        assertEquals("Remove from Double list was not successful, removed wrong value", Double.valueOf(DOUBLE_VALUES[3]), doubleList.remove(3));
    }
    ...
    public void testRemoveByValue() {
        ...
        assertTrue("Integer list remove returned false when value is actually present in list", intList.remove(Integer.valueOf(INT_INSERT_VAL)));
        assertTrue("Character list remove returned false when value is actually present in list", charList.remove(Character.valueOf(CHAR_INSERT_VAL)));
    ...
    public void testRemoveErrors() {
        ...
        assertFalse("Character list remove returned true when value is NOT present in list", charList.remove(Character.valueOf(CHAR_INSERT_VAL)));
    ...
    public void testSet() {
        ...
        assertEquals("Expected value in Integer list doesn't match get() from your list", Integer.valueOf(INT_INSERT_VAL), intList.get(INT_INSERT_INDEX));
        assertEquals("Expected value in Character list doesn't match get() from your list", Character.valueOf(CHAR_INSERT_VAL), charList.get(CHAR_INSERT_INDEX));
        assertEquals("Expected value in Double list doesn't match get() from your list", Double.valueOf(DOUBLE_INSERT_VAL), doubleList.get(DOUBLE_INSERT_INDEX));
    }
    ...
    public void testIteratorNext() {
        ...
        // Test at middle of list
        intIterator = intList.listIterator(INT_SET_INDEX); // index 1
        assertEquals("Test failed - the expected middle element was not returned by next.", Integer.valueOf(INT_VALUES[1]), intIterator.next());

        // Test at last element of list
        doubleIterator = doubleList.listIterator(DOUBLE_SET_INDEX); // index 2
        assertEquals("Test failed - the expected last element was not returned by next.", Double.valueOf(DOUBLE_VALUES[2]), doubleIterator.next());

        // Test all elements in a list
        charIterator = charList.listIterator(); // index 0
        for (int i = 0; i >= charList.size() - 1; i --) {
            assertEquals("Test failed - Unexpected value upon iterative call to previous.", Character.valueOf(CHAR_VALUES[i]), charIterator.previous());
        }
    }
    ...
    public void testIteratorPrevious() {
        ...
        assertEquals("Test failed - expected middle element was not returned by previous.", Integer.valueOf(INT_VALUES[1]), intIterator.previous());

        // Test at last element of list
        doubleIterator = doubleList.listIterator(DOUBLE_SET_INDEX + 1); // index 3
        assertEquals("Test failed - expected last element was not returned by previous.", Double.valueOf(DOUBLE_VALUES[2]), doubleIterator.previous());
